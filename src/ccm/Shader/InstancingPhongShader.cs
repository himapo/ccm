...
namespace ccm
{
    class InstancingPhongShader : Shader
    {
        Effect effect;
        ...
        public InstancingPhongShader(Game game)
            : base(game)
        {
        }
        ...
        {
            effect = ResourceManager.GetInstance().Load<Effect>("Effect/HardwareInstancingPhong");
        }
        ...
        void SetupEffect()
        {
            effect.CurrentTechnique = effect.Techniques["PixelLighting"];
